...
const FeatureCarousel = () => {
  const features = [
    {
      ...
      description:
        "AI-generated soundscapes optimized for coding, writing, or any creative work.",
    ...
    },
    {
      ...
      description:
        "Real-time focus score based on session duration and consistency.",
      imageurl: "/assets/icons/signal.svg",
    },
    {
      title: "Mood Personalization",
      description:
        "Select chill, intense, or uplifting vibes tailored to your workflow.",
      imageurl: "/assets/icons/smile.svg",
    },
    {
      title: "Session Analytics",
      description:
        "Track time focused, distractions avoided, and mood feedback after sessions.",
      imageurl: "/assets/icons/chart-bar.svg",
    },
    {
      title: "Auto Dark/Light Mode",
      description:
        "Smooth transitions between themes for day and night productivity.",
  ...
  const slideUp = {
    ...
    show: { opacity: 1, y: 0, transition: { duration: 0.7, delay: 1.5 } },
  };
